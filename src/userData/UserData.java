...
public void setDstct(String dstct) {
	this.dstct = dstct;
}
...
public void setEdateout(String edateout) {
	this.edateout = edateout;
}
public String getEtimeout() {
	return etimeout;
}
public void setEtimeout(String etimeout) {
...
public String getVmk() {
	return vmk;
}
public void setVmk(String vmk) {
	this.vmk = vmk;
}
